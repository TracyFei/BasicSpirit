...
function addOrder($ip_add, $run_cart) {
    ...
    while($row_cart = mysqli_fetch_array($run_cart)){
        ...
        while($row_products = mysqli_fetch_array($run_products)){
            ...
            $insert_customer_order = "insert into customer_orders (customer_id,due_amount,invoice_no,qty,size,order_date,order_status, pro_code) values ('$customer_id','$sub_total','$invoice_no','$pro_qty','$pro_size',NOW(),'$status', '$pro_code')";
            $run_customer_order = mysqli_query($db,$insert_customer_order);

            $insert_pending_order = "insert into pending_orders (customer_id,invoice_no,product_id,qty,size,order_status, pro_code) values ('$customer_id','$invoice_no','$pro_id','$pro_qty','$pro_size','$status', '$pro_code')";
